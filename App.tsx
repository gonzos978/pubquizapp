...
export default function JoinScreen() {
    ...
    const handleConnect = () => {
        ...
        // Update user count on user enter/leave
        sfs.addEventListener(SFS2X.SFSEvent.USER_ENTER_ROOM, (evt: any) => {
            setUserCount(evt.room.userCount);
        });
        sfs.addEventListener(SFS2X.SFSEvent.USER_EXIT_ROOM, (evt: any) => {
            setUserCount(evt.room.userCount);
        });
    ...
    return (
        <View style={styles.container}>
            {/* --- Connection/Room Status Indicator --- */}
